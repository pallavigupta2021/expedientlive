      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mx-auto">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="mb-6 text-text-light leading-relaxed text-center md:text-left">Expedient Consultancy Services is one of India’s fastest growing projects management consultancy firm in the field of infrastructure design.</p>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 gap-y-2">
              <ul className="space-y-2">
                ...
                <FooterLinkSimple to="/services/allservice">All Services</FooterLinkSimple>
                <FooterLinkSimple to="/services/bridge">Bridge Engineering</FooterLinkSimple>
              </ul>
              <ul className="space-y-2">
                <FooterLinkSimple to="/services/road">Highway Development</FooterLinkSimple>
                <FooterLinkSimple to="/services/tunnel">Tunnel Construction</FooterLinkSimple>
                <FooterLinkSimple to="/services/project-management">Project Management</FooterLinkSimple>
                <FooterLinkSimple to="/projects">Projects</FooterLinkSimple>
                <FooterLinkSimple to="/contact">Contact</FooterLinkSimple>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-4 w-full">
              <li className="flex items-start">
                ...
                <span className="text-text-light">Ground Floor, H.No. 208/9 State Bank Colony Station Road, Bareilly, Uttar Pradesh, 243001, India</span>
              </li>
        ...
        <div className="border-t border-border-color mt-12 pt-8 text-center">
          <p className="text-text-light">&copy; {new Date().getFullYear()} Expedientlive Research And Consultancy Private Limited. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
