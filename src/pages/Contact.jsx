                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-text-light">
                      Anil Associates<br />
                      6G6W+7R2, Bisalpur Rd<br />
                      Faridpur, Uttar Pradesh 243503
                    </p>
                  </div>
                </div>
      ...
      <section className="py-8 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="w-full h-[400px] bg-card-bg rounded-lg overflow-hidden border border-border-color">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3514.0376963471!2d79.4066195!3d28.2599499!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a0057c3d0c5e5d%3A0x7b8e9c9d9c5c5c5c!2sAnil%20Associates%2C%206G6W%2B7R2%2C%20Bisalpur%20Rd%2C%20Faridpur%2C%20Uttar%20Pradesh%20243503!5e0!3m2!1sen!2sin!4v1718194825037!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
          ...
          <div className="mt-4 text-center">
            <a
              href="https://maps.app.goo.gl/Nt9vZRQnGJJGJJaDSgS"
              target="_blank"
